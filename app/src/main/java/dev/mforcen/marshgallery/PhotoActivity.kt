...
class PhotoActivity : AppCompatActivity() {
    ...
    private val changePhotoRunnable = Runnable {
        newPhoto()
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.exitGalleryButton.setOnTouchListener(delayHideTouchListener)
        binding.exitGalleryButton.setOnClickListener { finish() }
        binding.nextButton.setOnClickListener {
            changePhotoHandler.removeCallbacks(changePhotoRunnable)
            newPhoto()
        }
    }
    ...
    private fun delayedPhotoChange(delayMillis: Long) {
        changePhotoHandler.removeCallbacks(changePhotoRunnable)
        changePhotoHandler.postDelayed(changePhotoRunnable, delayMillis)
    }

    private fun newPhoto() {
        thread {
            if(this.gallery == null) return@thread
            if(bitmap != null) {
                bitmap!!.recycle()
            }
